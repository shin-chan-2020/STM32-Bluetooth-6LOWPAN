...
/*
BLUETOOTH SPECIFICATION Version 4.2 [Vol 2, Part E] : page 982
7.8.12 LE Create Connection Command

The LE_Create_Connection command is used to create a Link Layer
connection to a connectable advertiser.
*/
/*
int hci_le_create_connection(
1. uint16_t interval,           : same as in aci_gap_start_selective_conn_establish_proc
2. uint16_t window,             : same as in aci_gap_start_selective_conn_establish_proc
3. uint8_t initiator_filter,    : see below Initiator_Filter_Policy
4. uint8_t peer_bdaddr_type,    : same as in aci_gap_start_selective_conn_establish_proc
5. const tBDAddr peer_bdaddr,   : same as in aci_gap_start_selective_conn_establish_proc
6. uint8_t	own_bdaddr_type,    : same as in aci_gap_start_selective_conn_establish_proc
7. uint16_t min_interval,       : same as in aci_gap_start_selective_conn_establish_proc
8. uint16_t max_interval,       : same as in aci_gap_start_selective_conn_establish_proc
9. uint16_t latency,            : same as in aci_gap_start_selective_conn_establish_proc
10.uint16_t supervision_timeout,: same as in aci_gap_start_selective_conn_establish_proc
11.uint16_t min_ce_length,      : same as in aci_gap_start_selective_conn_establish_proc
12.uint16_t max_ce_length       : same as in aci_gap_start_selective_conn_establish_proc
);

From BLUETOOTH SPECIFICATION Version 4.2 [Vol 2, Part E] : page 982 , 7.8.12 LE Create Connection Command
...
int hci_le_ltk_request_reply(uint8_t key[16]) /* LTK : Long Term Key*/
{
  struct hci_request rq;
