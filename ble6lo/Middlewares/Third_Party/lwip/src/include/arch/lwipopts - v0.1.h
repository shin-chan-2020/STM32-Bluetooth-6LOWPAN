...
#define MEM_LIBC_MALLOC             0 /* 0: use lwip internal allocator*/
#define MEMP_MEM_MALLOC             0 /* MEMP_MEM_MALLOC==0: Use lwip pool allocator*/
#define MEM_ALIGNMENT               4
#define MEM_SIZE                    (5 * 1024) /* MEM_SIZE: the size of the heap memory */
...
#define MEMP_NUM_TCP_SEG            32  /*the number of simultaneously queued TCP segments*/ // Anup : big bug
...
#define LWIP_MULTICAST_PING         0  /* LWIP_BROADCAST_PING==0: respond to unicast pings only (default). Not multicast pings*/
...
#define LWIP_TCPIP_CORE_LOCKING         0 //anup
